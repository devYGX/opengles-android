 ...
 * 圆形
 */
public class Circle extends ShapeRender {
    private int n = 360;
    ...
    private void initRender() {
        ...
        // 将360平分为N分;
        double ag = 360D / n;
        for (double i = 0; i < 360D + ag; i += ag) {
            vertexCoordinateArray[index++] = (float) (radius * Math.sin(i * Math.PI / 180d));
            vertexCoordinateArray[index++] = (float) (radius * Math.cos(i * Math.PI / 180d));
            vertexCoordinateArray[index++] = 0;
        }
